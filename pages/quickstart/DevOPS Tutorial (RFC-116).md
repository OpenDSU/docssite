...
<div id="myModal" style="display: none;">
  <span style="position: absolute; top: 15px; right: 35px; color: #f1f1f1; font-size: 40px; font-weight: bold; transition: 0.3s; cursor: pointer;" onclick="closeModal()">&times;</span>
